    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a OTTOCOIN address (e.g. VdNiYrYaCaXt8pVy2ygSeDaXXedz26jr15)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid OTTOCOIN address"));
        }
        else
        {
