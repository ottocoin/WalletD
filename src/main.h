...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 OTC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 OTC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 40000000 * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 10;
static const unsigned int POW_REAL_START_TIME = 1577837100; //  Wed, 01 Jan 2020 00:05:00 GMT
...
//int64 static GetBlockValue(unsigned int nTime);
